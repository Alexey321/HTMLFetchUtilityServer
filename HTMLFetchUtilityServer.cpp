		...
		Send&& send)
{
	...
	*/
	...
	long long duration;
	std::tie(page_source, duration) = get_web_page("http", "www.google.com", "search?source=hp&ei=PUs_XPGBKcfprgTX9ZrQDg&q=hello&btnK=%D0%9F%D0%BE%D0%B8%D1%81%D0%BA+%D0%B2+Google&oq=hello&gs_l=psy-ab.3..0l4j0i131l2j0l3j0i10.1675.2210..3727...0.0..0.105.499.2j3......0....1..gws-wiz.....0.FvjmjK7rut4");
	std::string resporce = "";
	...
	//bjam toolset=msvc-14.1 variant=release threading=multi link=static address-model=64 build-type=complete
}
...
int main(int argc, char* argv[])
{
	...
	if (argc != 5)
	{
		std::cerr <<
			...
			"Example:\n" <<
			"    HTMLFetchUtilityServer 127.0.0.1 80 . 1\n";
		return EXIT_FAILURE;
	}
